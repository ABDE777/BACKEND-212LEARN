...
import packPaymentRoutes from './routes/packPurchase.routes.js';
...
app.use(`${V1}/packs`,       packRoutes);
app.use(`${V1}/pack-payments`, packPaymentRoutes);
app.use(`${V1}`,             revenueRoutes);  // /instructor/earnings, /admin/revenue-shares
